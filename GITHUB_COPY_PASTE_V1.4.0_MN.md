# DoubleG Scanner v1.6.0 — GitHub руу шууд солих

## 1. ZIP задлах

`DoubleGScanner_v1.6.0_CompactNamedDetection_FullSource.zip` → Right click → Extract All.
...
6. Шинэ v1.6.0 folder-ийн **доторх бүх зүйл**-ийг repository root руу copy/paste хийнэ.
...
```text
Update DoubleG Scanner to v1.6.0 compact named detection
```
